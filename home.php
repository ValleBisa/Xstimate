    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
        ...
        <form class="d-flex" method="get" action="search.php">
          <input class="form-control me-2" type="search" placeholder="Cerca" name="valore" aria-label="Cerca">
...
<?php
        ...
        $sql = "SELECT Cod_preventivo, Cognome, Prezzo_tot, Data_Scadenza FROM cliente, preventivo WHERE cod_clienti = cod_cliente";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                  ...
                  $i++;
                  echo strtoupper("<b class=\"c1\">". "<span>Preventivo ".$row["Cod_preventivo"]." </span>". $row["Cognome"]. "</b> <br>");
